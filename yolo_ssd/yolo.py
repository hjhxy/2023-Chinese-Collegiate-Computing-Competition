...
from yolo_ssd.nets.yolo import YoloBody
from yolo_ssd.utils.utils import (cvtColor, get_anchors, get_classes, preprocess_input,
...
class YOLO_ONNX(object):
    _defaults = {
        ...
        "classes_path"      : 'model_data/Crack3Cls.txt',
        #---------------------------------------------------------------------#
        #   anchors_path代表先验框对应的txt文件，一般不修改。
        #   anchors_mask用于帮助代码找到对应的先验框，一般不修改。
        #---------------------------------------------------------------------#
